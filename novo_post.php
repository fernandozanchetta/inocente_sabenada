...
//die();
	if (!empty($_POST)) {
		...
		$salva_artigo = mysql_query("INSERT INTO posts SET conteudo = '".$conteudo."', usuario_id = '".$usuario_id."', downloads = 0, materia_id = '".$materia."', created = '".date("Y-m-d H:i:s")."'") or die(mysql_error());
	}
?>
